...
Sou desenvolvedor de software a 2 anos. Desenvolvi projetos para gestão de eventos, controle e monitoramento de equipamentos, automatização de processos financeiros, entre outros. 
Trabalhei em projetos voluntarios na graduação, como a Semana Integrada do Ceatec, startups de mobilidade urbana, e IoT, como Parkeen, e Fibo. Dessa forma, já desenvolvi firmware para sistemas embarcados, aplicações web (Frontend, backend, e banco de dados), aplicações mobile e desktop, e brokers mqtt.
